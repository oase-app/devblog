...
## Add expenses to your oases {{ date: '2023-10-16T00:00Z' }}
...
## Add events to your oases {{ date: '2023-08-20T00:00Z' }}
...
![](@/images/poll-options.png)

## Add poll options {{ date: '2023-08-10T00:00Z' }}

When the option you feel like is the right one for you isn't in the poll, you can add your own options.

### <SparkleIcon /> Achievements

- Adding new options to exisiting polls

---

![](@/images/polls.png)

## Add polls to your oases {{ date: '2023-08-01T00:00Z' }}
...
- Data is encrypted and decrypted on the clients only.
